...
class GoogleMapController {
  ...
  static Future<GoogleMapController> init(
    ...
    assert(id != null);
    await GoogleMapsCachedFlutterPlatform.instance.init(id);
  ...
  MethodChannel? get channel {
    if (GoogleMapsCachedFlutterPlatform.instance
        is MethodChannelGoogleMapsCachedFlutter) {
      return (GoogleMapsCachedFlutterPlatform.instance).channel(mapId);
    }
    return null;
  }
  ...
  void _connectStreams(int mapId) {
    if (_googleMapState.widget.onCameraMoveStarted != null) {
      GoogleMapsCachedFlutterPlatform.instance
    ...
    GoogleMapsCachedFlutterPlatform.instance.onLongPress(mapId: mapId).listen(
  ...
  Future<double> getZoomLevel() {
    return GoogleMapsCachedFlutterPlatform.instance.getZoomLevel(mapId: mapId);
  }

  /// Returns the image bytes of the map
  Future<Uint8List?> takeSnapshot() {
    return GoogleMapsCachedFlutterPlatform.instance.takeSnapshot(mapId: mapId);
  }

  /// Disposes of the platform resources
  void dispose() {
    GoogleMapsCachedFlutterPlatform.instance.dispose(mapId: mapId);
  }
}
